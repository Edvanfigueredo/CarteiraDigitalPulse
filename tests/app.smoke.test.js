...
describe('Pulse Finance — fluxo principal', () => {
  ...
  it('monta o app completo e navega por todas as telas sem exceções — com dados esparsos e, na sequência, com o modo demonstração (dataset cheio: dívida parcelada, metas, recorrências)', async () => {
    ...
    checkAllViews(); // dados esparsos (estado inicial deste arquivo de teste)

    // Reaproveita o MESMO mountApp já ativo em vez de montar de novo — dois
    // mountApp() no mesmo arquivo deixariam inscrições antigas do store
